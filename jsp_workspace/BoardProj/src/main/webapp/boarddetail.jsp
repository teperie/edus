	...
	<table border="1">
		...
		<tr>
			...
			<td class="td_right"><img
				src="${contextPath}/imageView?filename=${article.imgfilename}"
				width="100px" /></td>
		</tr>
		<tr>
			<td class="td_left"><label>파일다운로드</label></td>
			<td class="td_right"><a
				href="${contextPath}/fileDown?filename=${article.filename}">${article.filename }</a></td>
		</tr>
	</table>
	<br>
	<div id="commandCell">
		<a href="${contextPath}/boardModify?num=${num}">수정</a>&nbsp;&nbsp;&nbsp;
		<a href="">목록</a>&nbsp;&nbsp;&nbsp;
